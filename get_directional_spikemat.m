...
function spikemat_struct = get_directional_spikemat( spikemat, current, window_str, inout, contrast_flag )
    ...
    for i = 1:length(directions)
        ...
        [spikemat_struct(i).spikes spikemat_struct(i).contrasts spikemat_struct(i).events] = filtered_windowed_spikemat( spikemat, current, window_str, directions(i), inout, contrast_flag );
    end
