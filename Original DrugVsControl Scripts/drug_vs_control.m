function rslt = drug_vs_control( bhv_data, cell_data, plexon_tstamps )
...
for i = 1:ntrials
    ...
    window_start_time = start_time - 250;
    window_end_time = end_time + 250;
...
figure();
    for group = 1:NGroups
        ...
        % Convert to Matrix
        drug_on_full  = spikelist_fill( drug_on_spikes,  -500, 3500 ); %WANT real trial end time instead of 3500
        drug_off_full = spikelist_fill( drug_off_spikes, -500, 3500 ); %SAME SAME
